...
2. [`execFile(파일[,인수][,옵션][,콜백])`](#execfile파일인수옵션콜백)
...
1. [`execFileSync(파일[,인수][,옵션])`](#execfilesync파일인수옵션)
2. [`execSync(명령어[,옵션])`](#execsync명령어옵션)
3. [`spawnSync(명렁어[,인수][,옵션])`](#spawnsync명렁어인수옵션)
